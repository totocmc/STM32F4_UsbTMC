...
__ALIGN_BEGIN static uint8_t USBD_CDC_CfgHSDesc[USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  USB_CLASS_APPLICATION,                      /* bInterfaceClass: Communication Interface Class */
  USB_APPLICATION_SUBCLASS_TMC,               /* bInterfaceSubClass: Abstract Control Model */
  USB_TMC_PROTOCOL_NONE,                      /* bInterfaceProtocol: Common AT commands */
  0x00,                                       /* iInterface: */
  ...
  USB_CLASS_APPLICATION,                                       /* bInterfaceClass: CDC */
...
__ALIGN_BEGIN static uint8_t USBD_CDC_CfgFSDesc[USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x01,                                       /* bConfigurationValue: Configuration value */
  0x00,                                       /* iConfiguration: Index of string descriptor describing the configuration */
  0xC0,/*0x80 ?*/                                      /* bmAttributes: self powered */
  0x32,                                       /* MaxPower 0 mA */
